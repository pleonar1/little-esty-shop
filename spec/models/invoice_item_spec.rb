...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "instance methods" do
    it "can search and find the best bulk discount to apply" do
      ...
      invoice_item_1 = InvoiceItem.create!(invoice_id: invoice_1.id, item_id: item_1.id, quantity: 1, unit_price: 100, status: "shipped")
      ...
      expect(invoice_item1.best_bulk_discount).to eq(bulk_discount2)
      expect(invoice_item2.best_bulk_discount).to eq(nil)
    end
  end
end
